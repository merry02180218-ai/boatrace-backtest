"""One-off no-leak live judgment for 2026-09-05 Suminoe 10R. Screenshot inputs only; missing straight defaults neutral."""
import math
import numpy as np
...
DS='2026-09-05'; Y='2026/09/05'; CODE='202609051210'; SRC='analysis_v108_1head_feasibility.csv'; OUT='live_suminoe10_20260905_1head.md'
...
def main():
 ...
 L=['# 2026-09-05 住之江10R 1号艇 live','','- Screenshot values frozen pre-race.','- No result / payout / odds read.','- Straight original-exhibition not visible in screenshot; model neutral default used for straight only.',f'- prior ST-bias days: {days}',f'- role train head-win rows: {ntrain}',f'- p109: **{100*p:.1f}%**',f'- grade: **{g}**',f'- BUY(S-only operation): **{"BUY" if g=="S" else "SKIP"}**','','## v110 top7']+[f'{i}. **{t}**' for i,t in enumerate(top7,1)]
