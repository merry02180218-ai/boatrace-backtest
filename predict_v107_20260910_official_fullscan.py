"""2026-09-10 official pre-exhibition structural scan.
...
payout, or same-race odds are used. Prior same-frame waku history ends 2026-09-09.
"""
...
out_csv=Path('pred_v107_20260910_official_fullscan.csv')
out_md=Path('prediction_v107_20260910_official_fullscan.md')
if src_csv.exists():
    src_csv.replace(out_csv)
if src_md.exists():
    txt=src_md.read_text(encoding='utf-8').replace('2026-09-05','2026-09-10').replace('9/4以前','9/9以前')
