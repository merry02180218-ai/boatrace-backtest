...
OUT=Path('analysis_v289_3head_wave36_lda_stable_gate.csv')
OUTJ=Path('research_v289_3head_wave36_lda_stable_gate.json')
OUTM=Path('research_v289_3head_wave36_lda_stable_gate.md')
BASE={'races':94,'hits':52,'stake_yen':940000,'payout_yen':1622070}
QS=[.90,.93,.95,.97,.98,.99,.992,.995]
KS=[3,5]
    ...
    for qv in QS:
        ...
        for k in KS:
            ...
            if f['races']>=30 and e['races']>=10 and l['races']>=10:
                cand.append({'q':qv,'cut':cut,'k':k,'full':f,'early':e,'late':l,'worst_half_head_rate':min(e['head_rate'],l['head_rate'])})
