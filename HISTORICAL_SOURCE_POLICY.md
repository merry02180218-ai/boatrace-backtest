...
Decision: **reject** as od3 substitute because it is deadline/final-like and would leak future market movement relative to a T-10 simulation.
...
## No-leak invariant
Never substitute a final/deadline/post-race odds archive for a missing pre-close odds snapshot. Missing historical od3 stays missing. Odds are not required for the current live 20-ticket/manual-narrowing workflow.
