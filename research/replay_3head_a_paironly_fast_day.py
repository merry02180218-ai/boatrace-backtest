...
def main():
    ...
    summary={'date':a.date,'policy':'3HEAD_A_PAIR_ONLY_FAST_DIAGNOSTIC','pre_candidates':len(decisions),'live_evaluable':len(ev),'input_or_decision_errors':len(decisions)-len(ev),
